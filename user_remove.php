...
<body style="background: rgb(255, 255, 255, 0)">		
	<form class="new-user" method="post" action="user_remove.php">
		...
		<div class="input-group">
			<button type="submit" class="btn" name="user_remove_btn" onclick="return confirm('Quer mesmo remover utilizador?')"> Remover</button>
