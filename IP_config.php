...
<body style="background: rgb(255, 255, 255, 0)">		
	<form class="new-user" method="post" action="IP_config.php">

		<?php echo display_error(); ?>				
		<div class="input-group">
			<label>Piscina</label>
			<select name="poolName" id="user_type">
                <?php 
		...
		<div class="input-group">
			<button type="submit" class="btn" name="IP_register_btn"> Submeter</button>
